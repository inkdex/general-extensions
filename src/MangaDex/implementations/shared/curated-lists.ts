...
import { filterMangaRelationships } from "./parsers";
...
// Fetches a /list response and returns the curator's manga IDs in declared
// order. Returns null when the response is missing or malformed so callers can
// choose their own failure mode (discover throws, search returns empty).
