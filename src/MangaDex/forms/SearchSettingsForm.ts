...
export class SearchSettingsForm extends Form {
  ...
  private volumeState = new State<boolean>(this, "show_volume_in_subtitle", getShowVolume());
  private chapterState = new State<boolean>(this, "show_chapter_in_subtitle", getShowChapter());
  private statusIconsState = new State<boolean>(this, "show_status_icons", getShowStatusIcons());
