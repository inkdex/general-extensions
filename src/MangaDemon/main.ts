    ...
    CloudflareBypassRequestProviding
{
  ...
  async getMangaDetails(mangaId: string): Promise<import("@paperback/types").SourceManga> {
  ...
  async saveCloudflareBypassCookies(cookies: import("@paperback/types").Cookie[]): Promise<void> {
